...
const Sidebar = () => {
  ...
  return (
    <aside className="sidebar">
      <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/6df618ae8636df5739c65c0445c8a8045fd46b2191a0e0cf7d0ba0bd2ec097b1?placeholderIfAbsent=true&apiKey=3a4ca977ef8d444389c929708ee52065" alt="Main sidebar icon" className="sidebar-icon" />
      {sidebarItems.map((item, index) => (
        <SidebarItem key={index} iconSrc={item.iconSrc} altText={item.altText} />
      ))}
    </aside>
  );
};
