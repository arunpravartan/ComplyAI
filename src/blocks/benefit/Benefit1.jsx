...
export default function Benefit1({ heading, caption, bgImage, blockDetail }) {
  return (
...
Benefit1.propTypes = { heading: PropTypes.any, caption: PropTypes.any, bgImage: PropTypes.any, blockDetail: PropTypes.any };
