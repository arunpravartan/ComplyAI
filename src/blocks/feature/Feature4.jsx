...
export default function Feature4({ heading, caption, cards, image }) {
  return (
...
Feature4.propTypes = { heading: PropTypes.string, caption: PropTypes.string, cards: PropTypes.array, image: PropTypes.any };
