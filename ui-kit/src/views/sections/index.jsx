...
const sections = [
  {
    ...
    image: { light: `${imagePrefix}/navbar-light.svg`, dark: `${imagePrefix}/navbar-dark.svg` },
  ...
  },
  {
    ...
    image: { light: `${imagePrefix}/clientele-light.svg`, dark: `${imagePrefix}/clientele-dark.svg` },
  ...
  },
  {
    ...
    image: { light: `${imagePrefix}/testimonial-light.svg`, dark: `${imagePrefix}/testimonial-dark.svg` },
  ...
  },
  {
    ...
    image: { light: `${imagePrefix}/blog-light.svg`, dark: `${imagePrefix}/blog-dark.svg` },
    link: PAGE_PATH.blog,
    category: SectionCategory.MARKETING
  },
  {
    title: 'FAQs',
    subTitle: '7 Different Variants',
    image: { light: `${imagePrefix}/faqs-light.svg`, dark: `${imagePrefix}/faqs-dark.svg` },
    link: PAGE_PATH.faq,
    category: SectionCategory.ESSENTIAL
  },
  {
    title: 'Footer',
    subTitle: '7 Different Variants',
    image: { light: `${imagePrefix}/footer-light.svg`, dark: `${imagePrefix}/footer-dark.svg` },
  ...
  },
  {
    title: 'Team',
    subTitle: '8 Different Variants',
    image: { light: `${imagePrefix}/team-light.svg`, dark: `${imagePrefix}/team-dark.svg` },
    link: PAGE_PATH.team,
    category: SectionCategory.MARKETING
  },
  {
    title: 'Contact Us',
    subTitle: '6 Different Variants',
    image: { light: `${imagePrefix}/contact-us-light.svg`, dark: `${imagePrefix}/contact-us-dark.svg` },
  ...
  },
  {
    ...
    image: { light: `${imagePrefix}/gallery-light.svg`, dark: `${imagePrefix}/gallery-dark.svg` },
  ...
  },
  {
    ...
    image: { light: `${imagePrefix}/sign-in-light.svg`, dark: `${imagePrefix}/sign-in-dark.svg` },
  ...
  },
  {
    title: 'Register',
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/sign-up-light.svg`, dark: `${imagePrefix}/sign-up-dark.svg` },
  ...
  },
  {
    title: 'Pricing',
    subTitle: '9 Different Variants',
    image: { light: `${imagePrefix}/pricing-light.svg`, dark: `${imagePrefix}/pricing-dark.svg` },
  ...
  },
  {
    title: 'Small Hero',
    subTitle: '7 Different Variants',
    image: { light: `${imagePrefix}/small-hero-light.svg`, dark: `${imagePrefix}/small-hero-dark.svg` },
  ...
  },
  {
    ...
    image: { light: `${imagePrefix}/cookies-light.svg`, dark: `${imagePrefix}/cookies-dark.svg` },
  ...
  },
  {
    title: 'Top-Offer',
    subTitle: '5 Different Variants',
    image: { light: `${imagePrefix}/top-offer-bar-light.svg`, dark: `${imagePrefix}/top-offer-bar-dark.svg` },
  ...
  },
  {
    title: 'Mega Menu',
    subTitle: '5 Different Variants',
    image: { light: `${imagePrefix}/mega-menu-light.svg`, dark: `${imagePrefix}/mega-menu-dark.svg` },
  ...
  },
  {
    title: 'About',
    subTitle: '3 Different Variants',
    image: { light: `${imagePrefix}/content-light.svg`, dark: `${imagePrefix}/content-dark.svg` },
  ...
  },
  {
    ...
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/forgot-pass-light.svg`, dark: `${imagePrefix}/forgot-pass-dark.svg` },
  ...
  },
  {
    ...
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/new-pass-light.svg`, dark: `${imagePrefix}/new-pass-dark.svg` },
  ...
  },
  {
    ...
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/otp-gen-light.svg`, dark: `${imagePrefix}/otp-gen-dark.svg` },
  ...
  },
  {
    title: '404 Error',
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/404-light.svg`, dark: `${imagePrefix}/404-dark.svg` },
...

  {
    title: '500 Error',
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/500-light.svg`, dark: `${imagePrefix}/500-dark.svg` },
...

  {
    ...
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/maintenance-light.svg`, dark: `${imagePrefix}/maintenance-dark.svg` },
  ...
  },
  {
    title: 'Coming Soon',
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/coming-soon-light.svg`, dark: `${imagePrefix}/coming-soon-dark.svg` },
  ...
  },
  {
    title: 'Early Access',
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/early-access-light.svg`, dark: `${imagePrefix}/early-access-dark.svg` },
  ...
  },
  {
    title: 'Onboard',
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/onboard-light.svg`, dark: `${imagePrefix}/onboard-dark.svg` },
  ...
  },
  {
    title: 'Other',
    subTitle: '3 Different Variants',
    image: { light: `${imagePrefix}/other-light.svg`, dark: `${imagePrefix}/other-dark.svg` },
  ...
  },
  {
    ...
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/privacy-policy-light.svg`, dark: `${imagePrefix}/privacy-policy-dark.svg` },
  ...
  },
  {
    title: 'Typography',
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/typography-light.svg`, dark: `${imagePrefix}/typography-dark.svg` },
  ...
  },
  {
    title: 'Color',
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/color-light.svg`, dark: `${imagePrefix}/color-dark.svg` },
  ...
  },
  {
    title: 'Icons',
    subTitle: '1 Variant',
    image: { light: `${imagePrefix}/icon-light.svg`, dark: `${imagePrefix}/icon-dark.svg` },
    link: PAGE_PATH.icon,
    category: SectionCategory.ESSENTIAL
  }
];
