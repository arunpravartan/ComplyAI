...
export default function Benefit6({ bgImage, heading, caption, blockDetail }) {
...
Benefit6.propTypes = { bgImage: PropTypes.any, heading: PropTypes.any, caption: PropTypes.any, blockDetail: PropTypes.any };
