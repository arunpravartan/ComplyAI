...
export default function Benefit9({ heading, caption, blockDetail, exploreBtn }) {
  return (
...
Benefit9.propTypes = { heading: PropTypes.any, caption: PropTypes.any, blockDetail: PropTypes.any, exploreBtn: PropTypes.any };
