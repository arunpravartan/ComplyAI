      ...
      <Collapse in={open}>
        <Box sx={{ mb: 0.5 }}>
          {item.megaMenu && item.megaMenu.type === MegaMenuType.MEGAMENU1 && (
            <MegaMenu1
              {...{
                ...{ ...item.megaMenu, footerData: item.megaMenu.footerData },
          ...
          {item.megaMenu && item.megaMenu.type === MegaMenuType.MEGAMENU3 && (
            <MegaMenu3 {...{ ...{ ...item.megaMenu, footerData: item.megaMenu.footerData }, footerSX: { px: 5, ml: -2.5, mr: -5 } }} />
          )}
        ...
        >
          <>
            ...
            {item.megaMenu.type === MegaMenuType.MEGAMENU3 && (
              <MegaMenu3 {...{ ...item.megaMenu, footerData: item.megaMenu.footerData }} popperWidth={item.megaMenu.popperWidth || 725} />
            )}
